              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Welcome aboard Dhan Choliya Driver!'.tr,style:  TextStyle(fontFamily: 'SofiaProBold',fontSize: 16,color: notifier.textColor)),
                    const SizedBox(height: 6,),
                    Text('Login to Dhan Choliya Driver'.tr,style:  TextStyle(fontWeight: FontWeight.bold,color: notifier.textColor)),
                    const SizedBox(height: 20,),
                    ...
                    CommonButton(txt1: 'Login'.tr,containcolore: notifier.theamcolorelight,context: context,onPressed1: () {
                      ...
                      if(emailcontroller.text.isNotEmpty && passwordcontroller.text.isNotEmpty){
                        login(emailcontroller.text,passwordcontroller.text,).then((value) async {
                          print("++++++$value");
                          if(value["ResponseCode"] == "200"){
                            ...
                            SharedPreferences prefs = await SharedPreferences.getInstance();
                            var userData = jsonDecode(prefs.getString("loginData")!);
                            print(userData["id"]);
                            CollectionReference collRef = FirebaseFirestore.instance.collection('driver');
                            collRef.doc(userData["id"]).set({
                              'bus_id': "a0",
                              'driver_id':"0",
                              'ischeck': false,
                              'latitude': 10.20320,
                ...
                children: <Widget>[
                  ...
                  Column(
                    children: [
                      ...
                      Text('Dhan Choliya'.tr,style: TextStyle(color: notifier.theamcolorelight,fontSize: 20,fontFamily: 'SofiaProBold'),),
                    ],
                  ),
